...
pub const Floor = struct {
    ...
    pub fn draw(self: *const Self, shader: *const Shader) void {
        ...
        shader.bindTextureAuto("textureDiffuse", self.texture_floor_diffuse.gl_texture_id);
        shader.bindTextureAuto("textureNormal", self.texture_floor_normal.gl_texture_id);
        shader.bindTextureAuto("textureSpec", self.texture_floor_spec.gl_texture_id);
